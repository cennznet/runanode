...
const streamType = types.stream;
const streamMessageType = types.streamMessage;
const streamStatusType = types.streamStatus;
const streamPingType = types.streamPing;
