...
const jsonRpcLocalUrl = config.jsonRpc.localUrl;
...
export default [
  nodeJsonRpcSystemNameEpic,
  nodeJsonRpcSystemHealthEpic,
  nodeJsonRpcSystemChainEpic,
  nodeJsonRpcSystemVersionEpic,
  nodeJsonRpcSystemEpic,
];
