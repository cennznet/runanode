...
const TransferSentModal = ({ isTransferSentModalOpen, setTransferSentModalOpen, getSendTxPayload, transaction }) => {
  return (
    <Modal
      isOpen={isTransferSentModalOpen}
      footer={
        <ButtonGroup>
          <Button onClick={() => setTransferSentModalOpen(false)}>
            Close
          </Button>
        </ButtonGroup>
      }
